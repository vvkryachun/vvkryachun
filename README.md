...
▎3. Интеллектуальный чат-бот для поддержки клиентов в части юридических вопросов по операциям с недвижимостью

Описание: Разработал чат-бота на основе модели GPT-4, который способен обрабатывать запросы клиентов, предоставлять актуальную информацию и решать типичные проблемы без участия человека.
Технологии: Python, OpenAI API, Flask, GitHub Actions.
Ключевые достижения:

• Увеличение скорости ответа на простые вопросы клиентов на 90%.

• Снижение нагрузки на команду поддержки по простым вопросам на 100%.

• Ускорил процесс создания базы знаний на 40%.
